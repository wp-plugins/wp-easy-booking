...
class booking_addresses_class {
	...
	function booking_help_meta_box_callback( $post ) {
	   echo '<table width="100%" border="0">
		  <tbody>
			<tr>
			  <td>Use this shortcode <strong>[schd_calendar]</strong> in the content to display the booking calendar. Calendar will be visible in the Location Details page.</td>
			</tr>
		  </tbody>
		</table>';
	}
